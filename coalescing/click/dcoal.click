...
// Packet Processing
c0[0] -> Print(IN) -> Dcoalese() -> EtherEncap(0x0800, 00:08:a2:0d:db:3d, 00:08:a2:0d:e2:91) -> Print(OUT) -> out_eth1_128
c1[0] -> Dcoalese() -> EtherEncap(0x0800, 00:08:a2:0d:e2:91, 00:08:a2:0d:db:3d) -> out_eth1_126
// Strip required ??
